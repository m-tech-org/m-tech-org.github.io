...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "M-Tech - Innovate. Integrate. Inspire." },
    {
      name: "description",
      content:
        "Leading technology solutions provider delivering innovation and excellence in web development, mobile apps, cloud solutions, and AI.",
    },
  ];
}
